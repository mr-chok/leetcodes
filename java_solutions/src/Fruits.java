class Fruits {
    ...
    public int maxTotalFruits(int[][] fruits, int startPos, int k) {
        ...
        sum[0] = 0;
        // sum[] stores the prefix sum to track accumulated values.
        // Subtracting two entries gives you the total within a range,
        // avoiding the need to loop through each element individually.
        // In this way, sum[] acts as memoization.
        for (int i = 0; i < n; i++) {
